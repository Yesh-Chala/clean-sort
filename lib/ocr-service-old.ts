...
// Direct OCR service using Gemini API
export class OCRService {
  ...
  // Test function to verify API key and endpoint
  static async testAPI(): Promise<boolean> {
    try {
      ...
      const testResponse = await fetch(`${this.GEMINI_API_URL}?key=${this.GEMINI_API_KEY}`, {
        method: 'POST',
        headers: {
